...
{/* this is a opening menu  */}
        ...
        {/* this is sideNavbar */}
        {open?<motion.div initial={{x:-250}} animate={{x:0}} className="fixed left-0 w-[240px] bg-white h-[100vh] flex-col flex justify-between transition-transform transform translate-x-400 ease-in-out duration-300">
